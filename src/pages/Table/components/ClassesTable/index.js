            ...
            if (state["userDataStatus"]) {
                ...
                if (response.status === 200) {
                    if (isDesktop) {
                        ...
                        setTableData(shortenTableData(response.data["table"]));
                    };
                    navigate("/table", { state: { "userDataStatus": state["userDataStatus"], "tableData": response.data["table"] } });
                }
                else {
            ...
            <table className={styles.table}>
                <thead>
                    <tr className={"noselect"}>
                        <th className={isDesktop ? styles.topLeftIndex : styles.indexMobile} colSpan={isDesktop ? "2" : "1"}></th>
                ...
                <tbody>
                    <tr className={styles.classes}>
                        {isDesktop ? <th className={join("noselect", styles.index)}>1</th> : <></>}
                        <th className={join("noselect", styles.indexMobile)}>08:15<br />|<br />09:05</th>
                        <td className={isDesktop ? styles.data : styles.dataMobile}>
                    ...
                    <tr className={styles.classes}>
                        {isDesktop ? <th className={join("noselect", styles.index)}>2</th> : <></>}
                    ...
                    <tr className={styles.classes}>
                        {isDesktop ? <th className={join("noselect", styles.index)}>3</th> : <></>}
                    ...
                    <tr className={styles.classes}>
                        {isDesktop ? <th className={join("noselect", styles.index)}>4</th> : <></>}
                    ...
                    <tr className={styles.classes}>
                        {isDesktop ? <th className={join("noselect", styles.index)}>5</th> : <></>}
                    ...
                    <tr className={styles.classes}>
                        {isDesktop ? <th className={join("noselect", styles.index)}>6</th> : <></>}
                    ...
                    <tr className={styles.classes}>
                        {isDesktop ? <th className={join("noselect", styles.index)}>7</th> : <></>}
                    ...
                    <tr className={styles.classes}>
                        {isDesktop ? <th className={join("noselect", styles.index)}>8</th> : <></>}
